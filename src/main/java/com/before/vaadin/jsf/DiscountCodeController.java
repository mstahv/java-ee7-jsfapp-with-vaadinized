package com.before.vaadin.jsf;

import com.before.vaadin.DiscountCode;
import com.before.vaadin.jsf.util.JsfUtil;
import com.before.vaadin.jsf.util.PaginationHelper;
import com.before.vaadin.ejb.DiscountCodeFacade;
...
public class DiscountCodeController implements Serializable {
    ...
    @EJB
    private com.before.vaadin.ejb.DiscountCodeFacade ejbFacade;
